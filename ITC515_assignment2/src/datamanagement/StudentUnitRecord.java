...
public class StudentUnitRecord implements IStudentUnitRecord {
	...
	private float asg1Marks, asg2Marks, examMarks;	//Attribute variable to store assignment marks and exam marks

	/*
	 * Class constructor to initialize class attributes with values passed as argument
	 * @param id student id
